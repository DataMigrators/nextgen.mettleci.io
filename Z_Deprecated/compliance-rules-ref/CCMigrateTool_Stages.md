...
From time to time, older Stage Types are updated/replaced. While the
older Stage Types will continue to function, it is recommended to use
the newer replacement Stage Types.
...
-   If you are running v8.7, comment out all the v9.1, v11.5 and v11.7
    rules

-   If you are running v8.5, comment out all the v8.7, v9.1, v11.5 and
    v11.7 rules

-   If you are running below v8.5, comment out all the rules, but
    upgrade your environment soon. Seriously.
