...
You run a
`mettleci compliance query -asset \folder -queries \something -report "\something\something.csv”`
...
The use of `query` instead of `test` in your command is the cause of the
error you see.

See:

-   <a
    href="https://datamigrators.atlassian.net/wiki/spaces/MCIDOC/pages/458556115/Compliance+Query+Command"
    data-linked-resource-id="458556115" data-linked-resource-version="25"
    data-linked-resource-type="page">compliance query</a> command

-   <a
    href="https://datamigrators.atlassian.net/wiki/spaces/MCIDOC/pages/408322069/Compliance+Test+Command"
    data-linked-resource-id="408322069" data-linked-resource-version="29"
    data-linked-resource-type="page">compliance test</a> command

# Solution

When running your compliance rules, ensure that you use the
`compliance test` command and not `compliance query`.
