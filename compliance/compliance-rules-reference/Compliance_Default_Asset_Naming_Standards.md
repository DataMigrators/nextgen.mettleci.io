---
layout: page
title: Compliance_Default_Asset_Naming_Standards
parent: .
---

# Compliance Default Asset Naming Standards

This page summarises the default naming standards that are supplied with
the library of Compliance Rules which ship with MettleCI.

Your organisation is NOT required to use these standards. These are
simply defaults that ship with the MettleCI Compliance Library, with the
intent that you adapt them to your own team's needs.

-   [Parallel Job
    Stages](#ComplianceDefaultAssetNamingStandards-ParallelJobStages)
-   [Server Job
    Stages](#ComplianceDefaultAssetNamingStandards-ServerJobStages)
-   [Job Sequence
    Activities](#ComplianceDefaultAssetNamingStandards-JobSequenceActivities)
-   [Blocklist](#ComplianceDefaultAssetNamingStandards-Blocklist)
...
MettleCI also ships with
<a href="Job_Naming" data-linked-resource-id="2218197073"
data-linked-resource-version="2" data-linked-resource-type="page">a
Compliance Rule</a> which identifies jobs with names that suggest that
they are not intended as production candidates. This rule ships with an
in-built list is applied to Parallel, Server, and Sequence asset types.
You can configure the list by editing the definition of the relevant
Compliance Rule. e.g.,
