...
Test Case Data fabrication is a DataStage capability accessed via the unit test [data editor](../testing/editing-datastage-tests.md).  This page provides a set of steps to using it.
